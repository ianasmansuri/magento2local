...
namespace Elsnertech\Sorting\Ui\DataProvider\Product\Form\Modifier;
...
{   
    ...
    // Added a postion field in the configurable product option tab
        ...
        return [
            'record' => [
                ...
                'children' => [
                   ...
                   'optionsorting_container' => $this->getColumn(
                        'sorting_option',
                        __('Sorting option'),
                        [],
                        ['dataScope' => 'sorting_option']
                    ),
                    'actionsList' => [
                        'arguments' => [
                            'data' => [
