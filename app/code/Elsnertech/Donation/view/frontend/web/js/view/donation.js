    ...
    $.widget('mage.donation', {
        ...
        initDonationModal: function () {
            ...
            var options = {
                ...
                responsive: true,
                innerScroll: true,
                modalClass: 'elsnertech-modal-popup',
                buttons: []
            }
            ...
            var pMinLabel = $('.elsnertech-donation-minimal-amount-label-' + this.options.identifier);
            ...
            $('html').on('click', this.options.productSelector, function () {
                ...
                if (charity.data('productid') != '') {
                    ...
                    $('.elsnertech-donation-modal')
                        .modal(options)
                        .modal('openModal');

                    $('.elsnertech-modal-popup .modal-title').text(title);
                }
            });
